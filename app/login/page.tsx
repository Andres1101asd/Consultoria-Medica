      ...
      <div className="login-wrapper">
        ...
        <div className="welcome-section">
          ...
          <p className="welcome-text">
            Estamos encantados de verte de nuevo. Inicia sesión para acceder a tu cuenta y continuar disfrutando de todos nuestros servicios y funcionalidades.
          </p>
          ...
          <div className="login-card">
            ...
            <div className="login-footer">
              <p>
                ...
                {' | '}
                <Link href="/signup" className="forgot-password">
                  Registrarse
                </Link>
              </p>
            </div>
